...
namespace KalprajSolutions\Bitly\Client\Tests;
...
use KalprajSolutions\Bitly\Client\BitlyClient;
...
class BitlyClientTest extends TestCase
{
    ...
    public function testGetUrlInvalidResponseException() : void
    {
        ...
        self::expectException(\KalprajSolutions\Bitly\Exceptions\InvalidResponseException::class);
    ...
    public function testGetUrlInvalidResponse()
    {
        ...
        $this->expectException(\KalprajSolutions\Bitly\Exceptions\InvalidResponseException::class);
    ...
    public function testGetUrlInvalidResponseInvalidStatusCodeResponse()
    {
        ...
        self::expectException('\KalprajSolutions\Bitly\Exceptions\InvalidResponseException');
